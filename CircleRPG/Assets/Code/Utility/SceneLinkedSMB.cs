...
namespace Code.Utility
{
        ...
        where TMonoBehaviour : MonoBehaviour
    {
                                                  ...
                                                  AnimatorControllerPlayable controller)
        {
            ...
            if(animator.IsInTransition(layerIndex) && !m_LastFrameHappened &&
        ...
        /// </summary>
        public virtual void OnSLTransitionToStateUpdate(Animator          animator,
        ...
        /// </summary>
        public virtual void OnSLStateNoTransitionUpdate(Animator          animator,
                                                        AnimatorStateInfo stateInfo,
                                                        int               layerIndex)
        {
        }
        ...
        /// </summary>
        public virtual void OnSLStatePreExit(Animator animator, AnimatorStateInfo stateInfo,
                                             int      layerIndex)
        {
        }
