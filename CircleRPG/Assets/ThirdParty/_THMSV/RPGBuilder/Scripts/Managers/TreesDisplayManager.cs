...
{
    public class TreesDisplayManager : MonoBehaviour
    {
        ...
        public void ShowAbilityRequirements(RPGAbility ab, RPGTalentTree tree)
        {
            ...
            var rankREF = RPGBuilderUtilities.GetAbilityRankFromID(ab.ranks[curRank].rankID);
        ...
        public void ShowBonusRequirements(RPGBonus bonus, RPGTalentTree tree)
        {
            ...
            if (curRank == -1) curRank = 0;
            var rankREF = RPGBuilderUtilities.GetAbilityRankFromID(bonus.ranks[curRank].rankID);
                ...
                switch (t.requirementType)
                {
                    ...
                    case RequirementsManager.RequirementType.abilityKnown:
                        if (!CharacterData.Instance
                            .getTalentTreeNodeData(t.abilityRequiredID).known)
                            color = "<color=red>";
                        else
                            color = "<color=green>";
        ...
        public void InitTree(RPGTalentTree tree)
        {
            ...
            {
                var newAb = Instantiate(NodeSlotPrefab, t.GridLayoutRef.transform);
        ...
        private void InitTalentTreeNodeLines(RPGTalentTree thisTree, TreeNodeSlotDATA nodeData, Transform nodeTransform)
        {
            ...
            {
                TreeNodeHolder otherNodeREF = null;
                if(nodeData == null) Debug.LogError("null indeed");
            ...
            bool isLeft)
        {
            if (slotDifference == 0)
            {
                ...
                else
                {
                    ...
                    y = -y;
                    lineREF.points.Add(new Vector2(0, y));
