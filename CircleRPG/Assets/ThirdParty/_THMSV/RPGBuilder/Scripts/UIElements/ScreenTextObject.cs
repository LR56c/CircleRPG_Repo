...
namespace THMSV.RPGBuilder.UIElements
{
    public class ScreenTextObject : MonoBehaviour
    {
        ...
        {
            if (MobNodeToFollow != CombatManager.playerCombatInfo.gameObject)
            {
        ...
        public void ShowCombatText(string message, string eventType)
        {
            ...
            float RdmX = Random.Range(-60, 60);
            float RdmY = Random.Range(-60, 60);


            switch (eventType)
            {
                case "PHYSICAL_DAMAGE" when MobNodeToFollow == CombatManager.playerCombatInfo.gameObject:
                ...
                case "MAGICAL_DAMAGE" when MobNodeToFollow == CombatManager.playerCombatInfo.gameObject:
                    combatTextTMP.color = SelfDamageColor;
                    combatTextTMP.font = CombatTextFont;
                    combatTextTMP.fontSize = 40;
                    combatTextTMP.enableVertexGradient = false;
                ...
                case "NO_DAMAGE_TYPE" when MobNodeToFollow == CombatManager.playerCombatInfo.gameObject:
                    combatTextTMP.color = SelfDamageColor;
                    combatTextTMP.font = CombatTextFont;
                    combatTextTMP.fontSize = 40;
                    combatTextTMP.enableVertexGradient = false;
                ...
                case "NO_DAMAGE_TYPE":
                    ...
                    startPosition.y = RdmY;
                    break;
                case "THORN" when MobNodeToFollow == CombatManager.playerCombatInfo.gameObject:
                    combatTextTMP.color = SelfDamageColor;
                    combatTextTMP.font = CombatTextFont;
                    combatTextTMP.fontSize = 40;
                    combatTextTMP.enableVertexGradient = false;
                ...
                case "THORN":
                    ...
                    startPosition.y = RdmY;
                    break;
                case "HEAL" when MobNodeToFollow == CombatManager.playerCombatInfo.gameObject:
                ...
                case "HEAL":
                    ...
                    startPosition.y = RdmY;
                    break;
                case "HEAL_CRITICAL" when MobNodeToFollow == CombatManager.playerCombatInfo.gameObject:
                    combatTextTMP.color = HealColor;
                    combatTextTMP.font = CombatTextFont;
                    combatTextTMP.fontSize = 90;
                    combatTextTMP.enableVertexGradient = false;
                ...
                case "HEAL_CRITICAL":
                    ...
                    startPosition.y = RdmY;
                    break;
                case "EXP" when MobNodeToFollow == CombatManager.playerCombatInfo.gameObject:
                ...
                case "EXP":
                    ...
                    startPosition.y = RdmY;
                    break;
                case "IMMUNE" when MobNodeToFollow == CombatManager.playerCombatInfo.gameObject:
                ...
                case "IMMUNE":
                    ...
                    startPosition.y = RdmY;
                    break;
                case "BLOCKED" when MobNodeToFollow == CombatManager.playerCombatInfo.gameObject:
                    combatTextTMP.color = PhysicalDamageColor;
                    combatTextTMP.font = CombatTextFont;
                    combatTextTMP.fontSize = 40;
                    combatTextTMP.enableVertexGradient = false;
                ...
                case "BLOCKED":
                    ...
                    startPosition.y = RdmY;
                    break;
                case "DODGED" when MobNodeToFollow == CombatManager.playerCombatInfo.gameObject:
